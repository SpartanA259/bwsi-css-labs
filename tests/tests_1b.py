...
def test_addition():
    ...
    assert simple_calculator("add", -0, -5) == -5       # Test for negative zero and negative number
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", -0, -5) == 5   # Test for negative zero and negative number
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -0, 0) == 0    # Test for negative zero and zero
